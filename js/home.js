/* Assigning audio controls elements */
...
function slide(index) {
    ...
    var str2 = "Tribute Inc is a celebration of the music, movies and legacy. Join fans from around the world in Memphis as we remember the King of Rock 'n' Roll";
